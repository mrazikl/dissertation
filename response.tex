...
\begin{equation}
    \Dd{m_{\mathcal{R}}}{t}=\Dd{p_{\mathcal{R}}}{t}\frac{V_{\mathcal{R}}}{R_s T_{\mathcal{R}}}=Aj,
\end{equation}
...
Zavádíme zbezrozměrněné veličiny tlaku a~teploty \Unit{p_{in}, p_{out}, T_{R}}{-} (rozlišené šikmým řezem indexu) a~částečně zbezrozměrněnou viskozitu \Unit{\mu_0}{s}. Prostorové rozměry cely a~membrány vyjádříme souhrnně jako \Unit{S=V_{\mathcal{R}}L/A}{\square\meter}, dostáváme
\begin{equation}
...
\begin{subequations}
\begin{align}
\rho(x)&=\frac{K_p}{p_{\mathrm{in}}}\left(\frac{p_{\mathrm{out}}}{p_{\mathrm{in}}}\right)^{-{x}/{L}},\qquad K_p=\frac{p_0^2}{R_s T_0},\\
...
j&=-\frac{k}{\mu}\frac{p_0^2}{R_s T_0}\frac{1}{L}\ln\left(\frac{p_{\mathrm{out}}}{p_{\mathrm{in}}}\right),
\end{align}
\end{subequations}
